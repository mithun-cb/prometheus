...
install -D -m 0755 %{_builddir}/%{name}-%{version}.linux-arm64/prometheus %{buildroot}/usr/local/bin/prometheus
install -D -m 0755 %{_builddir}/%{name}-%{version}.linux-arm64/promtool %{buildroot}/usr/local/bin/promtool
